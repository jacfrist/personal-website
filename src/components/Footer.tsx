      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-2xl font-bold mb-2">Jacqueline Frist</h3>
            <p className="text-silver/80">Computer Science</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wider mb-4">Extra Info</h4>
              <ul className="space-y-2">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="https://linkedin.com/in/jacqueline-frist" className="text-timberwolf hover:text-silver transition-colors" aria-label="LinkedIn">
                  <Linkedin size={20} />
                </a>
                <a href="mailto:jacfrist@gmail.com" className="text-timberwolf hover:text-silver transition-colors" aria-label="Email">
                  <Mail size={20} />
                </a>
              </div>
            </div>
